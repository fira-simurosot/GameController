...
# source: SIM2REF/replacement.proto
...
RobotReplacement = _reflection.GeneratedProtocolMessageType('RobotReplacement', (_message.Message,), {
  ...
  '__module__' : 'SIM2REF.replacement_pb2'
